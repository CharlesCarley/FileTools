...
#define FT_MEMBERS_RESERVE 16         // Default Reserve space for members per struct.
...
#define FT_SWAP_FROM_NATIVE_ENDIAN 0  // Testing only to make sure endian swapping is correct.
#define FT_ARR_DIM_MAX 3              // Maximum dimensional array, EG; (int m_member[..][..] -> [FT_ARR_DIM_MAX])
#define FT_MAX_TOK 64                 // Maximum allowed C/C++ name (keyword, identifier, ...)

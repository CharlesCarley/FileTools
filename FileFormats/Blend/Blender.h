/*
    ...
    This file was automatically generated by: TableDecompiler.exe
    Mon Dec 30 06:32:12 AM
...
#pragma region MissingStructures
    ...
    // Pointers that are references to no known
    // struct need to be declared as a handle type
